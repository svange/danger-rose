    ...
    for character_name, sprite_path in [("danger", get_danger_sprite()), ("rose", get_rose_sprite())]:
        ...
        for test_case in test_cases:
            ...
            for row in range(rows + 1):
                y = row * frame_height
                if y < sheet_height:
                    pygame.draw.line(grid_sheet, (255, 0, 0), (0, y), (sheet_width, y), 2)
            
            for col in range(cols + 1):
                x = col * frame_width
                if x < sheet_width:
                    pygame.draw.line(grid_sheet, (255, 0, 0), (x, 0), (x, sheet_height), 2)
            ...
            if rows > 2:
                ...
                pygame.draw.rect(attack_viz, (0, 255, 0), (0, attack_y, sheet_width, frame_height), 4)
                pygame.image.save(attack_viz, str(test_dir / "attack_row_highlight.png"))
