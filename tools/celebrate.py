...
class Celebration:
    ...
    def draw_particles(self):
        ...
        for particle in self.particles:
            ...
            if self.type == 'confetti':
                ...
                for dx, dy in [(-size/2, -size/3), (size/2, -size/3), 
                               (size/2, size/3), (-size/2, size/3)]:
                    rx = dx * math.cos(math.radians(angle)) - dy * math.sin(math.radians(angle))
                    ry = dx * math.sin(math.radians(angle)) + dy * math.cos(math.radians(angle))
                ...
                if current_size > 0:
                    ...
                    pygame.draw.circle(self.screen, glow_color, (x, y), current_size + 2, 1)
    ...
    def run(self):
        ...
        while running:
            ...
            if self.type == "confetti" and len(self.particles) < 100 and random.random() < 0.3:
                self.particles.append({
                    'x': random.randint(0, 800),
                    'y': -20,
                    'vx': random.uniform(-2, 2),
