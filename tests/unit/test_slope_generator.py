...
from src.scenes.slope_generator import SlopeGenerator, TerrainChunk, ObstaclePool, Obstacle
...
class TestObstaclePool:
    ...
    def test_initialization(self, obstacle_pool):
        ...
        tree_count = sum(1 for o in obstacle_pool.inactive_obstacles if o.obstacle_type == "tree")
        rock_count = sum(1 for o in obstacle_pool.inactive_obstacles if o.obstacle_type == "rock")
        assert tree_count > 0
        assert rock_count > 0
