...
def test_attack_animation_cutting():
    ...
    for character_name, sprite_path in [("danger", get_danger_sprite()), ("rose", get_rose_sprite())]:
        ...
        for frame_width, frame_height in frame_sizes:
            ...
            test_dir = output_dir / f"{character_name}_{frame_width}x{frame_height}_attack"
            ...
            if y_start + frame_height > sheet_height:
                print(f"  Row 2 doesn't fit: {y_start} + {frame_height} = {y_start + frame_height} > {sheet_height}")
                continue
            ...
            for col in range(4):  # Try up to 4 columns
                ...
                if x_start + frame_width > sheet_width:
                    print(f"    Column {col} doesn't fit: {x_start} + {frame_width} = {x_start + frame_width} > {sheet_width}")
                    break
            ...
            if frames_extracted > 0:
                ...
                pygame.draw.rect(viz, (255, 0, 0), (0, y_start, sheet_width, frame_height), 3)
